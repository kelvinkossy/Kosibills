...
import { Users, User as UserIcon, Shield, ShieldCheck, UserPlus, CheckCircle2, X, Search, UserCheck, Wallet, MoreVertical, BarChart3, TrendingUp, PieChart, ChevronLeft, ChevronRight, Filter, AlertCircle, Download, Megaphone, Settings, Plus, Trash2, BellRing, MessageCircle, Send, Loader2, Bot } from 'lucide-react';
...
export default function AdminDashboard({ user, onBack }: AdminDashboardProps) {
  ...
  const handleDeleteSetting = async (key: string) => {
    ...
    const protectedSettings = ['transfer_fee', 'min_withdrawal', 'maintenance_mode', 'jwt_secret'];
    if (protectedSettings.includes(key)) {
      toast.error(`Cannot delete protected setting: ${key}. This setting is critical for system operation.`);
      return;
    }
                        ...
                        {!u.isAdmin && (
                          <>
                            <button
                              ...
                              className="p-2.5 rounded-lg text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors"
                            ...
                            <button
                              ...
                              className={`p-2.5 rounded-lg transition-colors ${u.accountStatus === 'frozen' ? 'text-red-600 bg-red-50 dark:bg-red-900/20' : 'text-slate-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20'}`}
                            ...
                            <button
                              ...
                              className={`p-2.5 rounded-lg transition-colors ${u.isAgent ? 'text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20' : 'text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20'}`}
                            ...
                            <button
                              ...
                              className={`p-2.5 rounded-lg transition-colors ${u.isCustomerCare ? 'text-blue-600 bg-blue-50 dark:bg-blue-900/20' : 'text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20'}`}
                            ...
                            <button
                              ...
                              className={`p-2.5 rounded-lg transition-colors ${u.isAdmin ? 'text-purple-600 bg-purple-50 dark:bg-purple-900/20' : 'text-slate-400 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20'}`}
